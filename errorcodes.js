PayZippy.errorCodes = {
	refund: {
		...
		"MULTIPLE_REFUNDS_UNSUPORTED":				"Multiple refunds are not supported for this transaction	If multiple partial refunds are not supported for the merchant or payment method",
		"PARTIAL_REFUNDS_UNSUPPORTED":				"Partial refunds are not supported for this transaction. Merchant should initiate the refund for full transaction amount - partial refunds are not supported for the merchant or payment method",
		"PAYZIPPY_TECHNICAL_ERROR":					"Refund could not be processed due to a technical error at PayZippy's end. Please contact PayZippy",
		"ACQUIRER_TECHNICAL_ERROR":					"Refund could not be processed due to a technical error at the bank's end. Please contact PayZippy",
		"REFUND_NOT_SUPPORTED":						"Refunds are not supported for this transaction	If the Refund config for the merchant is missing at PayZippy's end. Please contact PayZippy",
		"REFUND_WINDOW_EXPIRED":					"Refund on this transaction cannot be initiated beyond X days from sale transaction date. The max time frame specified by acquiring bank for refund has expired",
		"SALE_TRANSACTION_UNSUCCESSFUL":			"Refund cannot be processed because the sale transaction is unsuccessful",
		"SIMILAR_PREVIOUS_PARTIAL_REFUND_DETECTED":	"We have detected previous partial refund of the same amount a short while back. Please try again after sometime.	This is a check to prevent erroneous duplicate partial refunds by your refund/customer support team",
